...
export class AddCourseInFocusPage implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.route.paramMap.subscribe((param) => {
      if (param.has('mode') && param.get('mode') === 'edit') {
        ...
        this.addCourseInFocusForm = this.initFormByCourseInFocus(this.courseInFocus);
      } else {
  ...
  private initFormByCourseInFocus(courseInFocus: CourseInFocus) {
    return new FormGroup({
      courseName: new FormControl(courseInFocus.courseName, Validators.required),
      courseLink: new FormControl(courseInFocus.courseLink, Validators.required),
      description: new FormControl(courseInFocus.description, Validators.required),
